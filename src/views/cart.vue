...
<template>
  <div class="cart">
    <div class="cart-header">
      ...
      <div class="cart-header-main" v-if="cartList.length">
    ...
    <div class="cart-content">
      <div class="cart-content-main" v-for="(item,index) in cartList" :key="index">
        ...
        <div class="cart-count">
          <span class="cart-control-minus"
             @click="handleCount(index,-1)">-</span>{{item.count}}<span class="cart-control-add"
      ...
      <div class="cart-emtpy" v-if="!cartList.length">购物车为空</div>
    </div>
